...
control ingress(inout headers hdr,
    ...
    action set_multicast() {
        hdr.pkts.pkt_20 = 2;
        hdr.pkts.pkt_22 = hdr.pkts.pkt_22 + 1;
    }
    ...
    action set_broadcast() {
        hdr.pkts.pkt_20 = 4;
        hdr.pkts.pkt_22 = hdr.pkts.pkt_22 + 2;
    }
    ...
    action multicast_route_sm_star_g_hit_0(bit<32> mc_index, bit<32> mcast_rpf_group) {
        hdr.pkts.pkt_38 = 1;
        hdr.pkts.pkt_39 = mc_index;
        hdr.pkts.pkt_40 = 1;
        hdr.pkts.pkt_41 = mcast_rpf_group ^ hdr.pkts.pkt_42;
    }
    action multicast_route_bidir_star_g_hit_0(bit<32> mc_index, bit<32> mcast_rpf_group) {
        hdr.pkts.pkt_38 = 2;
        hdr.pkts.pkt_39 = mc_index;
        hdr.pkts.pkt_40 = 1;
        hdr.pkts.pkt_41 = mcast_rpf_group | hdr.pkts.pkt_43;
    }
    ...
    action multicast_route_s_g_hit_1(bit<32> mc_index, bit<32> mcast_rpf_group) {
        ...
        hdr.pkts.pkt_38 = 1;
        hdr.pkts.pkt_40 = 1;
        hdr.pkts.pkt_41 = mcast_rpf_group ^ hdr.pkts.pkt_45;
    }
